...
-- Zor#0348.lua | Made By Zor#0348 |
hookfunction(game.Players.LocalPlayer.IsInGroup, function() return true end)
game:GetService("StarterGui"):SetCore("SendNotification", {Title = "future.lua", Text = ".gg/futurelua", Duration = 7.7,});
...
local notificationLibrary = loadstring(game:HttpGet("https://raw.githubusercontent.com/Zorikos3/Private-Script-UI-Library/PrivateScript/Private-Script-UI-Library"))();
...
local NotifyLibrary = loadstring(game:HttpGet("https://raw.githubusercontent.com/Zorikos3/Notify-Library/PrivateScript/Notify-Library"))()
